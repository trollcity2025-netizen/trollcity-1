-- ============================================================================
-- SIMPLE FIX: Award XP for gifts without using calculate_level_details
-- This version directly updates XP without level calculation to ensure it works
-- ============================================================================
...
BEGIN
  ...
  -- 8. Update user_stats for sender (simple level calculation)
