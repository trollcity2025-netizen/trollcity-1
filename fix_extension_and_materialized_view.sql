...
-- ============================================================================
-- Option 2: Note - RLS cannot be enabled on materialized views
-- Materialized views don't support Row Level Security in PostgreSQL
-- Access control is handled via GRANT/REVOKE statements (see above)
-- ============================================================================

-- NOTE: The following RLS commands are NOT valid for materialized views
-- They are commented out to avoid errors:
-- ALTER MATERIALIZED VIEW public.user_earnings_summary ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY ... (not supported on materialized views)

-- If you need RLS-like behavior, consider using a regular view instead,
-- or handle access control at the application/API layer
