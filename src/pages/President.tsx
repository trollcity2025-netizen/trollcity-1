      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-purple-900/40 to-slate-950 pt-10 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            {/* President Card */}
            <div className="bg-gradient-to-br from-yellow-900/20 to-slate-900/80 backdrop-blur-xl border border-yellow-500/30 p-8 rounded-3xl relative overflow-hidden group hover:border-yellow-500/50 transition-all">
