...
export default function TrollPodsListing() {
  ...
  if (IS_UNDER_CONSTRUCTION) {
    return (
      <div className={`min-h-screen w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-x-hidden flex items-center justify-center p-4`}>
  ...
  return (
    <div className={`min-h-screen w-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white relative overflow-x-hidden p-4 md:p-8`}>
       {/* Background Effects */}
       <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute inset-0 ${trollCityTheme.overlays.radialPurple}`} />
